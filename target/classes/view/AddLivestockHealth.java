 ...
 * @author Admin
 */
public class AddLivestockHealth extends javax.swing.JDialog {
    private CertificateForm owner;  // Form cha để reload dữ liệu sau khi thêm

    public AddLivestockHealth(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
