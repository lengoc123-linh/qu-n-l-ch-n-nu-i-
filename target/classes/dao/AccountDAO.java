...
public class AccountDAO implements DAOInterface<Account> {
    ...
    public int insert(Account t) {
        ...
        try {
            ...
            //Buoc 5 Xu ly
              // Ghi lại hành động người dùng khi thêm tài khoản mới
        SystemActionHistoryDAO.getInstance().logUserAction(
            "Thêm tài khoản",  // Loại hành động
            "Thêm tài khoản mới: " + t.getUser(),  // Mô tả hành động
            t.getUser()  // Người thực hiện
        );
    ...
    public int update(Account t) {
        ...
        try {
            ...
            ketQua = pst.executeUpdate();
            // Ghi lại hành động người dùng khi cập nhật tài khoản
        SystemActionHistoryDAO.getInstance().logUserAction(
            "Cập nhật tài khoản",  // Loại hành động
            "Cập nhật thông tin tài khoản: " + t.getUser(),  // Mô tả hành động
            t.getUser()  // Người thực hiện
        );
            JDBCUtil.closeConnection(con);
    ...
    public int delete(Account t) {
        ...
        try {
            ...
            ketQua = pst.executeUpdate();
              ...
              // Ghi lại hành động người dùng khi xóa tài khoản
        SystemActionHistoryDAO.getInstance().logUserAction(
            "Xóa tài khoản",  // Loại hành động
            "Xóa tài khoản: " + t.getUser(),  // Mô tả hành động
            t.getUser()  // Người thực hiện
        );
