...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, 250, 70));

        jLabel3.setBackground(new java.awt.Color(0, 0, 51));
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/user.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 100, 100));
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 390, -1, -1));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/v2-98kme-wc51l.jpg"))); // NOI18N
        jLabel11.setText("jLabel11");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(-220, -200, 1140, 800));
                    ...
                    if (BCrypt.checkpw(passwordcheck, acc.getPassword())) {
                        if (acc.getStatus() == 1) {
                            try {
                                ...
                                // Thực hiện ghi lại lịch sử truy cập
                                UserAccessHistory history = new UserAccessHistory();
                                history.setUserName(acc.getUser());
                                history.setAccessTime(new Timestamp(System.currentTimeMillis())); // Lấy thời gian hiện tại
                                history.setFarmId(1); // Bạn có thể thay đổi farmId nếu cần
                                history.setIpAddress("127.0.0.1"); // Địa chỉ IP có thể lấy từ máy hoặc request
                                history.setDevice("Windows PC"); // Thiết bị có thể lấy từ máy hoặc yêu cầu
                                history.setAction("Login"); // Hành động là "Login"

                                // Ghi thông tin truy cập vào cơ sở dữ liệu
                                UserAccessHistoryDAO.getInstance().insert(history);
